...
const ReportDetails = () => {
  ...
  const report = useSelector((state) => state.userReport?.report);
  const loading = useSelector((state) => state.userReport?.loading);
  ...
  const reportDetails = [
    ...
    { label: "Reported User", value: report?.userId?.name || "Unknown" },
    {
      label: "Status",
      ...
      : []),
    {
      ...
      value: report?.userId?.mailAddress || "N/A",
    },
    {
      ...
      <div className="w-full max-w-8xl mx-auto bg-white rounded-xl shadow-md p-6">
        <div className="flex items-center justify-between border-b pb-4 mb-6 text-gray-700">
          <div className="flex items-center gap-3">
            <IoMdArrowBack
              ...
              onClick={() => navigate(-1)}
            />
            <span className="text-lg font-semibold">Reported by</span>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-center">
          <div className="flex-1 flex justify-center">
            <img
              src={report?.userId?.profileImg || "/vite.svg"}
              alt="report"
